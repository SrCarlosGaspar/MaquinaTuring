 ...
 * This class will display line numbers for a related text component. The text
 component must use the same line height for each line. CriaLinha
 ...
 a JScrollPane.
 */
public final class CriaLinha extends JPanel
    ...
    private final static int HEIGHT1 = Integer.MAX_VALUE - 1000000;
     ...
     */
    public CriaLinha(JTextComponent component) {
        this(component, 3);
    }
     ...
     */
    public CriaLinha(JTextComponent component, int minimumDisplayDigits) {
 ...
 <li>CriaLinha.RIGHT (default)
    ...
    private void setPreferredWidth() {
        ...
        if (lastDigits != digits) {
            ...
            d.setSize(preferredWidth, HEIGHT1);
            setPreferredSize(d);
            setSize(d);
        }
    }
